<template>
  <q-header id="navbar">
    <q-toolbar class="toolbar bg-white text-primary q-py-sm">
      <q-toolbar-title>
        <a class="logo-btn lt-sm" clickable @click="goHome()"> Mi portafolio </a>
      ...
      <div>
        <a class="nav-btn gt-xs" :class="{ 'active-link': currentRoute === '/support-me' }" clickable
          @click="goTo('/support-me')">
          <q-icon name="fas fa-circle-dollar-to-slot" size="18px" />
          <!-- <q-icon name="fas fa-hand-holding-dollar" size="18px" /> -->
          Apoyame
        </a>
        <a class="nav-btn gt-xs" :class="{ 'active-link': currentRoute === '/contact' }" clickable
          @click="goTo('/contact')">
          <q-icon name="fas fa-square-envelope" size="18px" />
          Contactame
        </a>
        <q-btn flat dense round class="menu-btn lt-sm" icon="menu" aria-label="Menu"
          @click="dropDownMenu = !dropDownMenu">
          <q-menu auto-close :offset="[15, 15]" transition-show="jump-down" transition-hide="jump-up" max-width="450px"
            max-height="93vh" class="lt-sm">
            <q-list class="dropdown-menu bg-primary text-white q-pt-xl"
              style="min-width: 300px; min-height: 85vh; margin-top: 0">
              <q-item class="q-pl-xl" :class="{ 'active-q-item': currentRoute === '/abtme' }" exact clickable v-ripple>
                <q-item-section style="display: inline-block" @click="scrollTo('abtme')">
                  <q-icon name="fas fa-circle-info" class="q-pr-sm" />
                  Sobre mi
                </q-item-section>
              </q-item>

              <q-item class="q-pl-xl" :class="{ 'active-q-item': currentRoute === '/projects' }" exact clickable v-ripple>
                <q-item-section style="display: inline-block" @click="scrollTo('projects')">
                  <q-icon name="fas fa-code-branch" class="q-pr-sm" />
                  Proyectos
                </q-item-section>
              </q-item>

              <q-item class="q-pl-xl" :class="{ 'active-q-item': currentRoute === '/services' }" exact clickable v-ripple>
                <q-item-section style="display: inline-block" @click="scrollTo('services')">
                  <q-icon name="fas fa-gear" class="q-pr-sm" />
                  Servicios
                </q-item-section>
              </q-item>

              <q-item class="q-pl-xl" :class="{ 'active-q-item': currentRoute === '/skills' }" exact clickable v-ripple>
                <q-item-section style="display: inline-block" @click="scrollTo('skills')">
                  <q-icon name="fas fa-laptop-code" class="q-pr-sm" />
                  Habilidades
                </q-item-section>
              </q-item>

              <q-item class="q-pl-xl" :class="{ 'active-q-item': currentRoute === '/testimonials' }" exact clickable
                v-ripple>
                <q-item-section style="display: inline-block" @click="scrollTo('testimonials')">
              ...
              <q-item class="lt-sm q-pl-xl" :class="{ 'active-q-item': currentRoute === '/support-me' }" exact clickable
                v-ripple @click="goTo('/support-me')">
                <q-item-section style="display: inline-block">
              ...
              <q-item class="lt-sm q-pl-xl" :class="{ 'active-q-item': currentRoute === '/contact' }" exact clickable
                v-ripple @click="goTo('/contact')">
                <q-item-section style="display: inline-block">
